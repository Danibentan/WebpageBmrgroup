...
export const products: Product[] = [
  { id: '1', slug: 'ventana-modena-a30', name: 'Ventana Modena A30', category: 'ventanas', material: 'aluminio', description: 'Aluminio · DVH', priceFrom: 400000, priceUnit: 'unidad', image: '/products/bmr-product-placeholder.svg', featured: true },
